...
| Espada | `WeaponBase` · `Sword` · `SwordTuning` | **E2** | Dos regresiones el mismo dia (2026-07-28). Variantes RT de taps X y continuidad tap → carga: falta re-probar jugando brillo, bloqueo del cargado hasta cerrar vueltas/Mover, proyectiles y alturas. Y su Y cargado terrestre (launcher) pasó a costar 1 barra —era el único cargado gratis del arma— y sin barra cae al tap normal: falta jugar si sigue valiendo la pena a ese precio. Clash mid-swing y ultimos detalles de mano orbital siguen pendientes |
