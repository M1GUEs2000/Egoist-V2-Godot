...
| Player — movimiento | `Player` · `PlayerLocomotion` · `PlayerDash` · `PlayerLauncher` · `PlayerWallSlide` · `PlayerEnemyBounce` | **E3** | Aprobado jugando: movimiento base, wall slide y launcher en E3; dash/airdash llegó a **E4** en su subnota (`Dash y Airdash`). Faltan juice y edge cases; el rebote en enemigos queda como la pieza más verde del bundle |
