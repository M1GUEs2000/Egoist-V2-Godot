...
| Player — movimiento | `Player` · `PlayerLocomotion` · `PlayerDash` · `Mover` · `Floater` · `PlayerWallSlide` · `PlayerEnemyBounce` | **E2** | Salto y doble salto reconstruidos (2026-07-21) como parabola dirigida calculada: altura de cuspide, distancia horizontal y duracion; hold define distancia y un porcentaje libera el control reducido. Falta probar jugando esos knobs y la autoridad post-liberacion. Dash/airdash llegó a **E4** en su subnota (`Dash y Airdash`). |
