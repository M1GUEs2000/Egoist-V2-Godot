...
| IA de combate en rango (engage + EVADE) | `GroundedEnemy` (engage/cadencia/receptor telegraph) · `GroundLocomotion.strafe` · `EnemyAIBlackboard` (intent STRAFE) | **E1** | Recién construido: correr headless/smoke y tunear jugando pausas entre combos, ring del orbit y chance/cooldown/duración del esquive; espejo LimboAI sin validar |
