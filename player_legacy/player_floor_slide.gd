class_name PlayerLegacyFloorSlide extends Node
...
## cuesta abajo como un tobogan. Modulo inyectable hermano de PlayerLegacyWallSlide: mismo contrato
...
## llama PlayerLegacy._on_jump cuando el jugador salta estando en slide.
