class_name PlayerLegacyDash extends Node3D
## Bloque (ex PlayerLegacyDash.cs): dash terrestre/aéreo + boost de momentum + dash ofensivo.
...
var _loco: PlayerLegacyLocomotion
...
func setup(body: PlayerLegacy, loco: PlayerLegacyLocomotion, register_air_hit_stall: Callable,
...
func _start_dash(dir: Vector3, distance: float, duration: float, boost_bump_momentum: bool,
	...
	# El dash borra la caída acumulada: sin esto, PlayerLegacy.vertical_velocity sobrevive al dash
