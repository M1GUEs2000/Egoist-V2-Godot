class_name PlayerLegacyCombat extends Node
## Enruta el input de ataque al arma del slot (ex PlayerLegacyCombat.cs). El daño lo aplica
...
## ultimo ataque iniciado. Lo consulta EnemyBase.resolve_parry via PlayerLegacy.current_parry_poise().
