...
- [ ] Verificar headless los cambios de meter/sprint del 2026-07-28: se commitearon sin `--import` ni smokes (no habia Godot en la maquina), incluido un assert nuevo en `combat_smoke_test` que nunca corrio — [[Smoke Test]] [[Meter]]
