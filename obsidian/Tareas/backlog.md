...
- [t] EVADE enemigo (esquive humano): tunear jugando chance/cooldown/duracion/rango de reaccion; sin i-frames enemigos por diseño — [[Comportamientos]] [[IA]] [[Stun]]
- [t] Engage en rango: tunear jugando la cadencia entre combos (attack_pause_min/max), los rings (melee_ring_fraction / ranged_ring_fraction), strike_distance_fraction, strafe_speed y backpedal_speed — [[Comportamientos]] [[IA]]
- [t] Giro comprometido del combo: tunear combo_turn_speed (entre golpes) y combo_swing_turn_speed (durante el swing) — [[Comportamientos]] [[IA]]
